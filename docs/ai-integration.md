...
Symphony runs prompts through configured AI CLI providers such as Claude, Codex, Antigravity, and Kimi. Each submitted prompt becomes a score. A score is durable and can be tracked by `score_id`.
