...
All six providers (Claude, Antigravity, Codex, Copilot, Kimi, OpenCode)
are wired into the discovery registry. Antigravity is a static
passthrough today — see ``_discover_antigravity`` for the reason —
while the others discover their model lists programmatically.
